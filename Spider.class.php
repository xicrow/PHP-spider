...
class Cosy_Spider {
	...
	public function setCurrentUrl($url) {
		...
		// Check site status
		if (in_array($this->currentSite->status, ['c', 'f'])) {
	...
	private function getNextUrl() {
		...
		if (in_array($this->options['crawlType'], ['deeper']) && !empty($this->currentSite->id) && !empty($this->currentSitePage->id)) {
		...
		if (in_array($this->options['crawlType'], ['site']) && !empty($this->currentSite->id)) {
		...
		if (in_array($this->options['crawlType'], ['all', 'internal'])) {
		...
		if (in_array($this->options['crawlType'], ['all', 'external'])) {
